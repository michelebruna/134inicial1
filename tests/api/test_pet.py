...
from utils.file_manager import ler_csv
...
def teste_incluir_pet():
    ...
    resultado_obtido = requests.post(
        url=url,
        headers=headers,
        data=open('C:\\Users\\miche\\PycharmProjects\\pythonProject\\134inicial1\\vendors\\json\\pet1.json')
    )
...
def teste_alterar_pet():
    ...
    resultado_obtido = requests.put(
        url=url,
        headers=headers,
        data=open('C:\\Users\\miche\\PycharmProjects\\pythonProject\\134inicial1\\vendors\\json\\pet2.json')
    )
...
@pytest.mark.parametrize(
    ...
    ler_csv('C:\\Users\\miche\\PycharmProjects\\pythonProject\\134inicial1\\vendors\\csv\\massa_incluir_pet.csv')
)
